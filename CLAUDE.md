...
- **Screen recordings get watched before they are published.** The two
  training clips were frame-checked for children, faces and legible client
  paperwork before being committed; they show adults and generic curriculum
  whiteboards. Audio was NOT verifiable here — no transcription available —
  so a spoken name remains unchecked.
